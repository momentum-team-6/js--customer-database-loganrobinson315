...
customersDiv.innerHTML += `<p class="email">${firstCustomer.email}</p>`
...
secondCustomersDiv.innerHTML += `<p class="email">${secondCustomer.email}</p>`
...
thirdCustomersDiv.innerHTML += `<p class="email">${thirdCustomer.email}</p>`
...
fourthCustomersDiv.innerHTML += `<p class="email">${fourthCustomer.email}</p>`
...
fifthCustomersDiv.innerHTML += `<p class="email">${fifthCustomer.email}</p>`
...
sixCustomersDiv.innerHTML += `<p class="email">${sixCustomer.email}</p>`
...
sevenCustomersDiv.innerHTML += `<p class="email">${sevenCustomer.email}</p>`
...
eightCustomersDiv.innerHTML += `<p class="email">${eightCustomer.email}</p>`
...
nineCustomersDiv.innerHTML += `<p class="email">${nineCustomer.email}</p>`
...
tenCustomersDiv.innerHTML += `<p class="email">${tenCustomer.email}</p>`
...
elevenCustomersDiv.innerHTML += `<p class="email">${elevenCustomer.email}</p>`
...
twelveCustomersDiv.innerHTML += `<p class="email">${twelveCustomer.email}</p>`
